...
SECRET_KEY = "django-insecure-^i^-$9m-(80uw3m_+uf^sto0s*y=w5fn#$!8sqt9bv8v49s=(u"
...
INSTALLED_APPS = [
    ...
    'rest_framework',
    'api',
    'corsheaders',#防止CORS拦截，注意使用这个需要pip相关包
]

MIDDLEWARE = [
    'corsheaders.middleware.CorsMiddleware', #防止CORS拦截
